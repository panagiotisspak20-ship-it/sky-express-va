            ...
            <div className="legacy-panel bg-white p-4 flex-1 flex flex-col">
                ...
                <div className="bg-emerald-50 border border-emerald-300 p-3 mb-4 text-sm">
                    ...
                    <p className="text-emerald-700 text-xs">
                        Fly any route worldwide with full SimBrief integration.
                        Enter your departure and destination, generate an OFP, and enjoy full
                        flight tracking, scoring, and PIREP generation.
                    </p>
                </div>
                ...
                {departure && arrival && (
                    <div className="bg-gray-50 border border-gray-300 p-3 mb-4">
                        ...
                        <div className="flex items-center gap-3 text-sm">
                            <span className="font-bold text-blue-900 text-lg">{departure.toUpperCase() || '????'}</span>
                            <div className="flex-1 flex items-center">
                                <div className="flex-1 border-t-2 border-dashed border-gray-400"></div>
                                <Plane className="w-4 h-4 text-emerald-600 mx-2" />
                                <div className="flex-1 border-t-2 border-dashed border-gray-400"></div>
                            </div>
                            <span className="font-bold text-blue-900 text-lg">{arrival.toUpperCase() || '????'}</span>
                        </div>
