                        ...
                        {pireps.map(p => (
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    {/* Grade Badge */}
                                    <div className={`w-10 h-10 flex items-center justify-center rounded font-bold text-xl border ${getGradeColor(p.grade || 'A')}`}>
                                        {p.grade || 'A'}
                                    </div>
                                ...
                                <div className="flex items-center gap-6 text-right">
                                    ...
                                    <div className="flex flex-col items-end">
                                        ...
                                        <span className={`font-mono font-bold ${Math.abs(p.landing_rate) < 200 ? 'text-green-600' : 'text-gray-800'}`}>
                                            {p.landing_rate} fpm
                                        </span>
                                    </div>
