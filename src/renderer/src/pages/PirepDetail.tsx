    ...
    <div className="p-4 font-tahoma bg-[#f0f0f0] h-full overflow-y-auto">
      ...
      <div className="max-w-4xl mx-auto space-y-4">
        ...
        <div className="legacy-panel bg-white p-4 flex justify-between items-center">
          <div>
            <h1 className="text-2xl font-bold text-[#1a365d] mb-1">PIREP: {pirep.flight_number}</h1>
          ...
          <div className="flex gap-4 text-center">
            ...
            <div className="p-2 border-r border-gray-200 pr-4">
              <div
                className={`text-3xl font-bold ${Math.abs(pirep.landing_rate) < 200 ? 'text-green-600' : 'text-orange-600'}`}
              >
                {pirep.landing_rate}
              </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="legacy-panel bg-white p-0 overflow-hidden flex flex-col">
            ...
            <div className="p-3 space-y-3 flex-1">
              ...
              {evts.map((e: any, i: number) => (
                <div
                  key={i}
                  className="flex gap-3 text-xs border-b border-gray-100 pb-2 last:border-0 relative"
                >
                  ...
                  {e.penalty > 0 && <div className="font-bold text-red-600">-{e.penalty}</div>}
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="space-y-4">
            <div className="legacy-panel bg-white p-3">
              ...
              <div className="grid grid-cols-2 gap-y-3 gap-x-6 text-xs">
                <div className="flex justify-between">
                  ...
                  <span
                    className={`font-mono font-bold ${(pirep.max_bank || 0) > 30 ? 'text-orange-600' : 'text-green-600'}`}
                  >
            ...
            <div className="legacy-panel bg-white p-3 flex flex-col items-center justify-center text-center h-32">
              ...
              <span
                className={`text-6xl font-black ${getGradeColor(pirep.grade)} bg-clip-text text-transparent bg-gradient-to-br from-current to-black/50`}
              >
                {pirep.grade || 'A'}
              </span>
            </div>
